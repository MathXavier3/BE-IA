  ...
  return (
    <section className="py-20 px-6 bg-gradient-to-b from-gray-800 to-black">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <div className="relative bg-gray-900/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/50 hover:border-gray-600/50 transition-all duration-300 h-full">
                {/* Glow Effect */}
                <motion.div
                ...
                <motion.div
                  ...
                  style={{
                    background: `linear-gradient(135deg, ${feature.glowColor}, transparent) border-box`,
        ...
        {/* Bottom Highlight */}
        <motion.div
          className="text-center mt-16 bg-gradient-to-r from-blue-900/20 to-emerald-900/20 rounded-2xl p-8 border border-blue-500/20"
