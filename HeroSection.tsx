  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6 overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        >
          <div className="p-4 rounded-full bg-gradient-to-r from-blue-500/20 to-emerald-500/20 backdrop-blur-sm border border-blue-500/30">
        ...
        >
          <div className="p-4 rounded-full bg-gradient-to-r from-emerald-500/20 to-blue-500/20 backdrop-blur-sm border border-emerald-500/30">
